...
export default function Details() {
  ...
  const shareMovieToWhatsApp = async (
    ...
    const message = `${title}${year}${synopsis}`;
      ...
      <View className="bg-primary flex-1">
        <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
          <View>
            ...
            <View className="flex absolute bottom-0 p-5 right-0 bg-primary rounded-t-lg gap-10 flex-row items-center justify-between">
              ...
              <TouchableOpacity
                ...
                onPress={async () => {
                  try {
                    ...
                    setAlertMessage(
                      nowFav ? "Movie removed from saved" : "Movie saved",
                    );
              ...
              {/* touchable que compartir peliculas */}
              <TouchableOpacity
                className="flex flex-col items-center gap-1"
                onPress={() => shareMovieToWhatsApp(movie)}
              >
                <FontAwesome5 color={"#25D366"} name="whatsapp" size={30} />
              </TouchableOpacity>
            </View>
          </View>
