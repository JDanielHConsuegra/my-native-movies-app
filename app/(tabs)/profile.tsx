...
export default function Profile() {
  ...
  return (
    <View className="flex-1 pb-10 bg-primary">
      ...
      <Image
        source={icons.logo}
        className="h-[100px] w-[160px] rounded mt-20 mb-5 mx-auto"
      />
      <View className="py-10 flex flex-col gap-5 px-5">
        {/* User Avatar/Icon */}

        {/* User Info */}
        <View className="bg-dark-200/60 rounded-lg p-5 mb-5">
        ...
        {/* Logout Button */}
        <TouchableOpacity
          className="bg-red-800 rounded-lg p-4 items-center mt-5"
          onPress={logOut}
        >
